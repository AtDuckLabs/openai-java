...
import com.atduck.openai.*;
import com.atduck.openai.assistants.*;
import com.atduck.openai.audio.*;
...
import com.atduck.openai.billing.BillingUsage;
import com.atduck.openai.billing.Subscription;
import com.atduck.openai.client.OpenAiApi;
...
import com.atduck.openai.completion.CompletionResult;
...
import com.atduck.openai.messages.ModifyMessageRequest;
...
import com.atduck.openai.runs.CreateThreadAndRunRequest;
import com.atduck.openai.runs.Run;
import com.atduck.openai.runs.RunCreateRequest;
import com.atduck.openai.runs.RunStep;
...
public class OpenAiService {
     ...
     * Creates a new OpenAiService that wraps OpenAiApi
     *
     * @param config   OpenAi ApiConfig instance
     */
    public OpenAiService(final OpenAiApiConfig config) {
        ObjectMapper mapper = defaultObjectMapper();
        OkHttpClient client = defaultClient(config.getToken(), config.getTimeout());
        Retrofit retrofit = defaultRetrofit(client, mapper, config.getHost());
    ...
    public static Retrofit defaultRetrofit(OkHttpClient client, ObjectMapper mapper) {
        return defaultRetrofit(client, mapper, BASE_URL);
    }

    private static Retrofit defaultRetrofit(OkHttpClient client, ObjectMapper mapper, String host) {
